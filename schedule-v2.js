/* ITDETI SCHEDULE V2 — unified add UI + recurring events + safe recurring delete */
(function () {
  ...
  function refreshSchedule() {
    return Promise.all([window.loadCalendar?.(), window.loadStudents?.(), window.loadDashboard?.()]);
  }
  ...
  function scheduleView() {
    const heading = [...document.querySelectorAll('h1')].find(x => x.textContent.trim().toLowerCase() === 'расписание');
